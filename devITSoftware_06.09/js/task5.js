...
Перевіряю чи є значення певної властивості обєктом. Якщо так, то викликаю функцію objectToArray рекурсивно 
для цього вкладеного об'єкта та додаю масив [key, objectToArray(obj[key])] у масив result, Це дозволить 
зберегти структуру вкладеності об'єктів у вихідному масиві.
